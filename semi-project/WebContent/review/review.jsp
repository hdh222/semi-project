					...
					<div class="row">
						...
						<div class="col-xl-5 border-right">
							<img id="review_img"
								...
								alt="" class="rounded float-left ml-5 my-4  border" />
						</div>
						
						-->
						<!-- 이미지 백업 -->

						<div id="carouselExampleIndicators" class="carousel slide col-xl-5 border-right"
							data-ride="carousel">
						...
						<div class="col-xl-6 mx-4">
							<br>
							<h3 class="border-bottom">이것이 자바다 리뷰</h3>

							<p class="small my-1">글쓴이 : 홍길동 &nbsp;&nbsp; 작성일 : 0000.00.00
								&nbsp;&nbsp; 평점 : ★★★★★</p>

							<p class="my-5">택배로 온 책을 보고 두꺼워서 조금 놀랐는데, 1/2권 분책이 가능한 형태였다.
